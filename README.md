...
<p align="justify"> 👩‍🎓 Welcome to my GitHub profile! I’m Shruti Pawar, a passionate and driven software developer dedicated to crafting impactful and scalable digital solutions. With a strong foundation in both creative problem-solving and technical expertise, I transform ideas into innovative and high-performance applications. </p> <p align="justify"> 💻 <strong>Languages & Scripting:</strong><br> • Java<br> • Python<br> • Bash<br> • SQL<br> • HTML, CSS, JavaScript </p> <p align="justify"> 🧠 <strong>AI/ML:</strong><br> • AI/ML model development<br> • Python-based data processing </p> <p align="justify"> 📱 <strong>Application Development:</strong><br> • Android Development<br> • WordPress (CMS & REST API)<br> • Front-end Web Development<br> • Backend Logic Design </p> <p align="justify"> 🐧 <strong>Operating Systems & Environments:</strong><br> • Linux (system tuning and performance optimization)<br> • Shell scripting & automation </p> <p align="justify"> 🗄 <strong>Database Technologies:</strong><br> • SQL<br> • RDS (AWS)<br> • BigQuery (GCP)<br> • Cloud Storage (GCP) </p> <p align="justify"> ☁️ <strong>Cloud Platforms:</strong><br> • AWS (EC2, S3, RDS, VPC, Lambda, Route 53, ALB, CodePipeline)<br> • GCP (BigQuery, Looker, Cloud Storage, IAM Roles, App Engine, Pub/Sub, Prometheus)<br> • Multi-cloud architecture & optimization </p> <p align="justify"> 🛠 <strong>DevOps Tools:</strong><br> • Docker & Docker Swarm<br> • Kubernetes<br> • Jenkins<br> • Terraform<br> • Ansible<br> • Maven<br> • Grafana<br> • Prometheus </p> <p align="justify"> 🔒 <strong>Cybersecurity & Network Tools:</strong><br> • Network Security & Cloud Security<br> • Ethical Hacking & Threat Intelligence<br> • Tools: Wireshark, Kali Linux<br> • Certifications: Cisco CyberOps, CompTIA Security+, CCNA </p> <p align="justify"> 📘 <strong>SAP & Enterprise Technologies:</strong><br> • SAP ABAP (modularization, internal tables, DDIC)<br> • SAP S/4HANA, ABAP on HANA (ADT - Eclipse)<br> • Reporting: ALV, Classical, Interactive<br> • Data Migration: LSMW, BDC, DMC<br> • Enhancements: BADI, BAPI<br> • CDS Views, AMDP, SmartForms </p> <p align="justify"> 🚀 Over the last five years, I have been on a continuous journey to refine my skills and adapt to emerging technologies. Whether developing sophisticated AI/ML models or architecting scalable software systems, I am committed to staying at the forefront of technological advancements. </p> <p align="justify"> 🔧 I thrive in collaborative environments and value open communication with developers, designers, and stakeholders. I am passionate about the synergy that arises from shared ideas and diverse expertise, leading to exceptional outcomes. </p> <p align="justify"> 💭 I approach each project with a creative mindset, striving to craft solutions that are not only functional but also elegant and efficient. I believe in the power of clean, maintainable code that stands the test of time and scales with the needs of the user. </p> <p align="justify"> 🌱 Outside of coding, you’ll find me exploring the outdoors, tinkering with electronics, or experimenting with new recipes. I approach both technology and life with a sense of curiosity, always learning and embracing new challenges. </p> <p align="justify"> ⌨ GitHub is my platform to collaborate, innovate, and contribute to the vibrant global developer community. I’m always open to new connections and opportunities to build something extraordinary. Let's collaborate and create something impactful! </p>
